...
const Hero = () => {
    return (
        <>
        <div className='lg:flex justify-around gap-0 py-10'>
        ...
        <div>
            <div className="grid grid-cols-2 gap-12 place-content-center py-6 overflow-x-hidden">
        ...
        <div>
            <div className='flex justify-around items-center flex-wrap lg:gap-[0.5rem]  sm:gap-4 md:justify-between sm:justify-between shadow-lg p-10 lg:w-[89%] mt-6 sm:width-[100%] gap-5 w-screen rounded-2xl lg:mx-auto'>
