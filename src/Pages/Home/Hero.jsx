...
const Hero = () => {
  ...
  return (
    <div>
        ...
        <div>
            <div className={`flex justify-around lg:mt-12 items-center flex-wrap lg:gap-[0.5rem]  sm:gap-4 md:justify-between sm:justify-between shadow-lg p-10 lg:w-[90%] md:w-[100%] mt-6 sm:w-[100%] gap-5 w-screen rounded-2xl lg:mx-auto card ${theme}`}>
