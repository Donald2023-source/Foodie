...
const Hero = () => {
  ...
  return (
    <div>
        <div className='lg:flex justify-between mx-auto lg:w-[85%] lg:gap-[10rem] lg:p-2 md:p-7 p-1'>
        ...
        <div>
            <div className="grid grid-cols-2 lg:gap-12 gap-y-5 place-content-center py-6 overflow-x-hidden">
                <div className={`h-42 shadow-lg hover:shadow-2xl hover:text-white transition ease-in duration-300 cursor-pointer hover:bg-gradient-to-tr hover:bg-[#f47628] rounded-xl lg:w-56 flex flex-col items-center mx-2 card ${theme} justify-center`}>
